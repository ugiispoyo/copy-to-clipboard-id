            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (options === null || options === void 0 ? void 0 : options.text) {
                        ...
                        el = document.getElementById(options === null || options === void 0 ? void 0 : options.id);
                        nodeName = el === null || el === void 0 ? void 0 : el.nodeName;
                        switch (nodeName) {
                            case "INPUT":
                    ...
                    return [4 /*yield*/, window.navigator.clipboard.writeText(textCopy)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
